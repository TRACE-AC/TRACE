...
OBJECTIVE_INSTRUCTION_BASE = (
    ...
    "Propose a repair strategy in plain text for the buggy code based on the root cause. "
    "Below are repair templates for reference. If one or more templates are matched, you can refer to their repair approaches. If none apply, suggest your own approach:"
)
